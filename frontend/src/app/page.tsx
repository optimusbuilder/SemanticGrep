  ...
  async function search(event: FormEvent) {
    ...
    try {
      const payload = await apiRequest<SearchResponse>("/api/search", {
        method: "POST",
        body: JSON.stringify({ query: query.trim(), repository: indexJob.repository, language: language || undefined }),
      });
